...
/// AppKit-native tip button — the analogue of SwiftUI's `TipButton`.
///
///     let btn = TipNSButton(product: "net.frwrd.app.tips.small")
...
/// `TipUIButton` from the UIKit module.
@MainActor
public final class TipNSButton: NSButton {
